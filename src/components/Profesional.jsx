                        ...
                        <div className='row'>
                            <div className='col-md-8 offset-md-3 border rounde p-4 mt-2 shadow'>
                                ...
                                <div className="mb-3">
                                    ...
                                    <input type="text" className="form-control" id="ubicacion" name="ubicacion" placeholder="Ubicación" onChange={this.onChangeHandler} />
                                </div>
                                <div className="mb-3">
                                    <label for="formGroupExampleInput2" className="form-label">Profesión</label>
                                    <input type="text" className="form-control" id="profesion" name="profesion" placeholder="Profesión" onChange={this.onChangeHandler} />
                                </div>
