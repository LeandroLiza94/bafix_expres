    ...
    return ( 
            ...
            <div className="row " >
                ...
                {servicios && servicios.map(servicio =>
                                                ...
                                                <div className="col-4">
                                                    <div className="row">
                                                        ...
                                                        <button  className="btn btn-warning" 
                                                            data-bs-toggle='modal' data-bs-target='#mimodal4' onClick={() => cambiarModal(servicio)}>
                    ...
                    <div id='mimodal4' className='modal modal-lg fade ' aria-hidden='true'>
                        <div className="modal-dialog" role="document">
                            <div className="modal-content">
                            <div className="modal-header">
                                <h5 className="modal-title">Servicio N°: {modal[7]}</h5>
                                <button type="button" className="close"  data-bs-toggle='modal' data-bs-target='#mimodal4' aria-label="Close">
                            ...
                            <div className="modal-footer">
                                ...
                                <div className="row" style={{width:"100%"}}>
                                    <div className="col-6">
                                        <button type="button" className="btn btn-primary"  data-bs-toggle='modal' data-bs-target='#mimodal4' onClick={onButtonClick}>Descargar Recibo</button>
                                    </div>
                                    <div className="col-6">
                                        <button type="button" className="btn btn-secondary"  data-bs-toggle='modal' data-bs-target='#mimodal4'>Cerrar</button>
                                    </div>
                                </div>
                                : null}   
...
export default ServiciosFinalizadoC