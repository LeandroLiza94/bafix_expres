    ...
    render() {
        return (
            ...
            <div className="d-flex align-items-start">
                    ...
                    <button className="nav-link active" onClick={ <Solicitados />  } id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#v-pills-home" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true" >Datos Cliente</button>
